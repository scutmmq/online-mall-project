    ...
    <div class="common-layout">
        <el-container class="container">
            ...
            <el-aside width="170px" class="aside">
                <ElMenu :router="true" base="/merchant" default-active="main" :unique-opened="true">
                    ...
                    <el-sub-menu index="products">
                        ...
                        <el-menu-item index="stock"><el-icon>
                                <Sell />
                    ...
                    <el-menu-item index="reviews"><el-icon>
                    ...
                    <el-sub-menu index="settings">
                        ...
                        <el-menu-item index="profile"><el-icon>
                                <User />
                            </el-icon>商家信息</el-menu-item>
                        <el-menu-item index="address"><el-icon>
                                <Location />
